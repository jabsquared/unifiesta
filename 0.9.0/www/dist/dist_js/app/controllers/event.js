...
app.controller('EventCtrl', ['$scope', '$state', '$stateParams', 'eventData', '$ionicHistory', 'reminderService', function($scope, $state, $stateParams, eventData, $ionicHistory, reminderService) {
